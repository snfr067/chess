const CACHE_NAME = "taiwan-dark-chess-pwa-mobile-r9-20260617-landscape-only";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=mobile-r9-20260617-landscape-only",
  "./app.js?v=mobile-r9-20260617-landscape-only",
